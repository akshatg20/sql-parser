...
################################
	...
	# collapsed_names_with_ids = [ [ t[1], t[0] ] for t in tuples ]
	...
	collapsed_trie = CollapsedTrie(le_dict, ge_dict)
	...
	idx_stat = [idx_year_start, trie, collapsed_trie, ge_dict, le_dict, basic_stats] 
